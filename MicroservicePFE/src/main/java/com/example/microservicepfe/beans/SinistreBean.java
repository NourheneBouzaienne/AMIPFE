...
public class SinistreBean {
    ...
    public SinistreBean(String IMMAT, Long CODE_ETAT, String NUMSNT, String CITESINI, String REGSINI, String GOUVSINI, String LIBPRDT, String NUMCNT, String DTSURV, String HEURESINI, String n_SINISTRE, String DT_ETAT, Float TOTALREMBOURSE, String ETAT_QUIT, String ETAPEACTUELLE) {
        this.IMMAT = IMMAT;
        this.CODE_ETAT = CODE_ETAT;
        this.NUMSNT = NUMSNT;
        this.CITESINI = CITESINI;
